### Today's Agenda:
       > 10:30 to 11:30 -> Target Locators -> Alert
       > 11:30 to 11:45 -> Activity
       > 11:45 to 12:30 -> Frames


# Steps:
   - Whenever you find an alert check whether it is inspectable or not
   - If it is not inspectable -> Confirm that -> its a Javascript function
   - To handle the alert -> switch the driver focus to the alert
