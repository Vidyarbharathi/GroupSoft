...
Activity:
1. Create an Interface say Payments
     - cashOnDelivery();
     - upiPayments();
     - cardPayments()
     - internetBanking();
2. Create an Abstract class SingaporeBank that implements Payments Interface
     - add abstract recordPaymentDetails()
3. Create a concrete class Amazon that inherits SingaporeBank      
